...
public class SearchAsyncHelper extends Fragment {
    private static String TAG="SearchAsyncHelper";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(TAG,"mInput:"+mInput);
        Log.d(TAG,"mOpenMode"+mOpenMode);
        Log.d(TAG,"mRootMode:"+mRootMode);
        Log.d(TAG,"isRegexEnabled:"+isRegexEnabled);
        Log.d(TAG,"isMatchesEnabled:"+isMatchesEnabled);
