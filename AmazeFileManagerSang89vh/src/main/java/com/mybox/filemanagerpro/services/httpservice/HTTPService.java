...
public class HTTPService extends Service implements Runnable {
    ...
    static public final String ACTION_STARTED = "com.mybox.filemanagerpro.services.httpservice.HTTPReceiver.HTTPSERVER_STARTED";
    static public final String ACTION_STOPPED = "com.mybox.filemanagerpro.services.httpservice.HTTPReceiver.HTTPSERVER_STOPPED";
    static public final String ACTION_CHANGE_PASSWORD = "com.mybox.filemanagerpro.services.httpservice.HTTPReceiver.HTTPSERVER_CHANGE_PASSWORD";
    static public final String ACTION_FAILEDTOSTART = "com.mybox.filemanagerpro.services.httpservice.HTTPReceiver.HTTPSERVER_FAILEDTOSTART";

    // RequestStartStopReceiver listens for these actions to start/stop this server
    static public final String ACTION_START_HTTPSERVER = "com.mybox.filemanagerpro.services.httpservice.HTTPReceiver.ACTION_START_HTTPSERVER";
    static public final String ACTION_STOP_HTTPSERVER = "com.mybox.filemanagerpro.services.httpservice.HTTPReceiver.ACTION_STOP_HTTPSERVER";
